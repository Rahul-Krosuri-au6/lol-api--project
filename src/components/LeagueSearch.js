  ...
  filter: function (e) {
    ...
    if (value == "any") {
      ...
      for (let key in this.state.games) {
        if (
          value == this.state.games[key].stats.item0 ||
          value == this.state.games[key].stats.item1 ||
          value == this.state.games[key].stats.item2 ||
          value == this.state.games[key].stats.item3 ||
          value == this.state.games[key].stats.item4 ||
          value == this.state.games[key].stats.item5 ||
          value == this.state.games[key].stats.item6
        ) {
